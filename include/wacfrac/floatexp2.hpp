...
namespace wacfrac::experimental {
...
template<std::floating_point M, std::integral E>
struct std::formatter<wacfrac::experimental::FloatExp<M, E>> : std::formatter<double> {
    auto format(const wacfrac::experimental::FloatExp<M, E>& v, std::format_context& ctx) const {
