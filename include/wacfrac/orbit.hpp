...
auto compute_reference(multi_complex c, unsigned int max_n, bool do_escape = true) -> std::vector<std::complex<double>>; // TODO: Check if it is possible no references should escape
