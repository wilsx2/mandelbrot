...
template auto compute_reference<std::complex<double>>(MultiComplex c, std::size_t max_n, bool do_escape) -> std::vector<std::complex<double>>;
...
template auto compute_reference<std::complex<long double>>(MultiComplex c, std::size_t max_n, bool do_escape) -> std::vector<std::complex<long double>>;
...
template auto escape_perturbed<DoubleExpComplex>(const std::vector<DoubleExpComplex>& ref, DoubleExpComplex dc, std::size_t max_n, DoubleExpComplex dz, std::size_t n) -> std::pair<DoubleExpComplex, std::size_t>;
template auto compute_reference<DoubleExpComplex>(MultiComplex c, std::size_t max_n, bool do_escape) -> std::vector<DoubleExpComplex>;
}   // namespace wacfrac
