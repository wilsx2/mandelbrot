benchmark: \
  ...
  liblibwacfrac.a \
  /usr/lib/libbenchmark_main.so.1.9.5 \
  /usr/lib/libboost_log_setup.so.1.91.0 \
  /usr/lib/libboost_log.so.1.91.0 \
  /usr/lib/libboost_filesystem.so.1.91.0 \
  /usr/lib/libboost_regex.so.1.91.0 \
  /usr/lib/libboost_thread.so.1.91.0 \
  /usr/lib/libboost_atomic.so.1.91.0 \
  /usr/lib/libboost_chrono.so.1.91.0 \
  /usr/lib/libboost_container.so.1.91.0 \
  /usr/lib/libboost_date_time.so.1.91.0 \
  /usr/lib/libboost_serialization.so.1.91.0 \
  /usr/lib/libtbb.so.12.18 \
  /usr/lib/gcc/x86_64-pc-linux-gnu/16.1.1/../../../../lib/libmpc.so \
  /usr/lib/gcc/x86_64-pc-linux-gnu/16.1.1/../../../../lib/libmpfr.so \
  /usr/lib/gcc/x86_64-pc-linux-gnu/16.1.1/../../../../lib/libgmp.so \
